...
my ($mnt, @args) = @ARGV;
my $h = eval { Data::MinHash::Shared->new("$mnt/x.shm", @args) };
print $h ? "created\n" : "refused: $@";
P
close $fh;
...
($sig, $out) = on_small_tmpfs('DATA_MINHASH_SHARED_SPARSE=1', 1 << 20);
is $sig, SIGBUS, 'DATA_MINHASH_SHARED_SPARSE=1 skips the reservation';
